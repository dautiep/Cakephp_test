        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th><?= $this->Paginator->sort('user_salutation') ?></th>
                    ...
                    <th><?= $this->Paginator->sort('user_position') ?></th>
                    <th><?= $this->Paginator->sort('user_department') ?></th>
                    <th><?= $this->Paginator->sort('user_organization') ?></th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $this->Number->format($user->user_salutation) ?></td>
                    ...
                    <td><?= $this->Number->format($user->user_organization) ?></td>
                    <td class="actions">
